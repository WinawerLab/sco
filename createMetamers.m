...
function createMetamers(textureSynthPath, pyrToolsPath, knkpath, imgDir, outputDir, imgIdx, numScales, numOrientations, sizeNeighborhood, Niter, numVersions)
% arguments:
% 
...
% (will do this with a different seed).
    ...
    for ii=imgIdx
        ...
        for jj=1:numVersions
            ...
            % this does.
            V1Metamer = ifft2(fft2(baseImage) .* generaterandomphase(128));       
